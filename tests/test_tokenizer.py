...
#import resource
try:
    import resource  # Unix / Linux 才有
except ImportError:
    resource = None  # Windows 等平台没有
import sys
...
if __name__ == "__main__":
    ...
    # print('pass test_empty_matches_tiktoken')

    # test_single_character_matches_tiktoken()
    # print('pass test_single_character_matches_tiktoken')

    # test_roundtrip_single_unicode_character()
    # print('pass test_roundtrip_single_unicode_character')

    # test_single_unicode_character_matches_tiktoken()
    # print('pass test_single_unicode_character_matches_tiktoken')
    
    # test_roundtrip_ascii_string()
    # print('pass test_roundtrip_ascii_string')

    test_ascii_string_matches_tiktoken()
    print('pass test_ascii_string_matches_tiktoken')

    test_roundtrip_unicode_string_with_special_tokens()
    print('pass test_roundtrip_unicode_string_with_special_tokens')

    test_unicode_string_with_special_tokens_matches_tiktoken()
    print('pass test_unicode_string_with_special_tokens_matches_tiktoken')

    test_overlapping_special_tokens()
    print('pass test_overlapping_special_tokens')

    test_address_roundtrip()
    print('pass test_address_roundtrip')

    test_german_roundtrip()
    print('pass test_german_roundtrip')

    test_german_matches_tiktoken()
    print('pass test_german_matches_tiktoken')

    test_tinystories_sample_roundtrip()
    print('pass test_tinystories_sample_roundtrip')

    test_tinystories_matches_tiktoken()
    print('pass test_tinystories_matches_tiktoken')

    test_encode_special_token_trailing_newlines()
    print('pass test_encode_special_token_trailing_newlines')

    test_encode_iterable_tinystories_sample_roundtrip()
    print('pass test_encode_iterable_tinystories_sample_roundtrip')

    test_encode_iterable_tinystories_matches_tiktoken()
    print('pass test_encode_iterable_tinystories_matches_tiktoken')
